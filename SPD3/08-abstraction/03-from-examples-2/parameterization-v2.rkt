...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname parameterization-v2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ())))
...
(check-expect (filter2 zero? (list 1 3 7 8 9)) empty)
(check-expect (filter2 string-lower-case? (list "cat" "DOG" "bat")) (list "cat" "bat"))
(check-expect (filter2 false? (list false true false false true)) (list false false false))
(check-expect (filter2 (lambda (x) (> x 5)) (list 1 3 7 8 9)) (list 7 8 9))
